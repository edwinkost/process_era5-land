...
OUT_FOLDER="/scratch/depfg/sutan101/test_arise_meteo_europe_demo/daily_after_remapcon/test_all_variables/"

# set the folder where you stored daily files
INP_FOLDER="/scratch/depfg/sutan101/test_arise_meteo_europe_demo/daily_before_remapcon/"
